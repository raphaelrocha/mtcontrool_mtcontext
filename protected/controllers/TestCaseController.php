...
class TestCaseController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','delete','index','view','Selectdos','Selectdos1'),
		...
		if (isset($_POST['TestCase'])) {
			...
			if ($model->save()) {
				Yii::app()->user->setFlash(TbHtml::ALERT_COLOR_SUCCESS,
                         '<strong>Well!</strong> Test Case saved with sucess!');
	...
	public function actionUpdate($id)
	{
		...
		if (isset($_POST['TestCase'])) {
			...
			if ($model->save()) {
				Yii::app()->user->setFlash(TbHtml::ALERT_COLOR_SUCCESS,
    '<strong>Well!</strong> Test Case updated with sucess!');
                   Yii::app()->controller->refresh();
			}
            }}catch (Exception $e){
                        Yii::app()->user->setFlash(TbHtml::ALERT_COLOR_ERROR,
