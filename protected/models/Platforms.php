...
{  
	...
	public function relations()
	{
		...
		return array(
			'apps' => array(self::MANY_MANY, 'App', 'app_platform(id_platform, id_app)'),
			'criterias' => array(self::HAS_MANY, 'Criteria', 'id_platform'),
			'runs' => array(self::HAS_MANY, 'Runs', 'id_platform'),
                        'characteristic' =>array(self::MANY_MANY,'Characteristic','characteristic_platforms(id_characteristic, id_platform)'),
