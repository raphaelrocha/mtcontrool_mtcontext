 ...
 *
 * The followings are the available columns in table 'app_platform':
 ...
 */
class AppPlatform extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_app, id_platform', 'required'),
			array('id_app, id_platform', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_app, id_platform', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return AppPlatform the static model class
	 */
