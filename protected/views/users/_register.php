...
<?php echo TbHtml::Button('<i class="fa fa-arrow-left"></i> Back', array('onclick' => 'js:document.location.href="/mtcontrool"',
		    ...
		    'size'=>TbHtml::BUTTON_SIZE_SMALL,
             ...
             <?php echo TbHtml::submitButton ( $model->isNewRecord ? '<i class="fa fa-check fa-lg"></i> Create' : 'Save',
    ...
    <?php echo $form->errorSummary($model); ?>
           ...
           <!--echo $form->dropDownListControlGroup($model,'country',array('span'=>3, 'maxlength'=>100)); -->
     <?php  echo $form->dropDownListControlGroup($model,'country',CHtml::listData(Country::model()->findAll(), 'id', 'name'),
        ...
        <?php echo $form->dropDownListControlGroup($model,'level',array('Tester')); ?>
    </br>
