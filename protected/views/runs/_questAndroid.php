...
<div class="well">
		...
		?>
                <p><?php echo TbHtml::b('Display'); ?></p>
		<?php
		echo TbHtml::checkBoxList ( 'checkDisplay', '', array (
				'24.7' => CHtml::encode ( 'Does your app produce assistive text which can be displayed on the device?' ),
                                '24.11' => CHtml::encode ('Does your app address reading comprehension issues?'),
		) );
		?>
                <p><?php echo TbHtml::b('External Devices'); ?></p>
		<?php
		echo TbHtml::checkBoxList ( 'checkExternalDevices', '', array (
				'26.7' => CHtml::encode ( 'Does your app produce assistive text-to-speech in conjunction with an external audio output device?' ),
                                '26.8' => CHtml::encode ( 'Does your app produce assistive text which can be output through an external display? ' )
		) );
		?>
	</div>
