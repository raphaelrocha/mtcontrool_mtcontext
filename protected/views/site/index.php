...
<link rel="stylesheet" type="text/css"
	href="<?php echo Yii::app()->request->baseUrl; ?>/css/test.css" />
...
<div class="container-footer">
 ...
 <?php echo CHtml::image(Yii::app()->request->baseUrl."/images/ufam2.png","indt",array( 'width'=>'65px','height'=>'65px')); ?> 
      
</div>
           
    <!--   <br/>
     <p class="txt-railway"> MTControol &copy;  by UFAM. </p>    -->
</div>
